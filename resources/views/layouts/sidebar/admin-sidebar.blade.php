        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::routeIs('member') ? 'active' : '' }}" href="{{ route('member') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::routeIs('dashboard') ? 'active' : '' }}" href="#navbar-dashboards" data-toggle="collapse" role="button"
                            aria-expanded="true" aria-controls="navbar-dashboards">
                            <i class="fa fa-users"></i>
                            <span class="nav-link-text">Data Member</span>
                        </a>
                        <div class="collapse {{ Request::routeIs('dashboard') ? 'show' : '' }}" id="navbar-dashboards">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('dashboard') }}"
                                        class="nav-link {{ Request::routeIs('dashboard') ? 'active' : '' }}">Alternative</a>
                                </li>
                            </ul>
                        </div>
                    </li>
